...
def fix_file(filepath):
    ...
    if 'from typing import' in content:
        ...
        needs_union = ' | ' in content and 'None' not in content.split(' | ')[1] if ' | ' in content else False
    ...
    content = re.sub(r'(\w+): dict\[str, Any\] \| None', r'\1: Optional[Dict[str, Any]]', content)
    
    # Fix str | list[str] -> Union[str, List[str]]
    content = re.sub(r'(\w+): str \| list\[str\]', r'\1: Union[str, List[str]]', content)
