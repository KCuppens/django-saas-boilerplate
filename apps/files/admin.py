...
class FileUploadAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'original_filename', 'file_type', 'file_size_human', 
        'is_public', 'download_count', 'created_by', 'created_at'
    ]
    ...
    fieldsets = (
        (None, {
            'fields': ('original_filename', 'filename', 'file_type', 'mime_type')
        }),
        ('File Details', {
            'fields': ('file_size', 'file_size_human', 'checksum', 'storage_path')
        }),
        ('Settings', {
            'fields': ('is_public', 'description', 'tags', 'expires_at')
        }),
        ('Statistics', {
